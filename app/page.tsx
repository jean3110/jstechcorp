...
const t = {
  en: {
    ...
    hero: {
      ...
      stat3: "$399", stat3l: "one-time setup — no surprises",
    },
    problem: {
      label: "The Problem",
    ...
    pricing: {
      ...
      setup: "Setup & Build", setup_price: "$399", setup_note: "one-time fee",
      monthly: "Automation & Support", monthly_price: "$149", monthly_note: "per month",
  ...
  pt: {
    ...
    hero: {
      ...
      stat3: "$399", stat3l: "implementação única — sem surpresas",
    },
    problem: {
      label: "O Problema",
    ...
    pricing: {
      ...
      setup: "Implementação", setup_price: "$399", setup_note: "pagamento único",
      monthly: "Automação e Suporte", monthly_price: "$149", monthly_note: "por mês",
